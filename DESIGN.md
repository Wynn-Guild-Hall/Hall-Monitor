...
A slot held by somebody who no longer speaks for the guild prints as `unclaimed`. They keep the slot and have lost the role (§6), and the roster's only job is to say who to ask — naming somebody who has moved on sends the room to the wrong person. Same for a holder who has left the server.
